...
- (void)viewDidAppear:(BOOL)animated {
	Stat(@"home_intobadgedetail");
}

- (void)getBadgeInfo {
    NSString *url = [NSString stringWithFormat:@"%@/getbadge?id=%@&u_fcrid=%@", 
					 ROOT_URL, badge.bid, badge.userId];
